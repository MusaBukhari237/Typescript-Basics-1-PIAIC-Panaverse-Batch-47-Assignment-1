...
console.log("Is year != 2020? I predict False.");
console.log(year != 2020);
...
console.log("Is car == 'subaru' and year == 2020? I predict True.");
console.log(carname == "subaru" && year == 2020);
console.log("Is car == 'subaru' or year == 2019? I predict True.");
console.log(carname == "subaru" || year == 2019);
